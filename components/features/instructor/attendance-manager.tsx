...
import {
  createInstructorAttendanceAction,
  deleteInstructorAttendanceAction,
  updateInstructorAttendanceAction,
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Log, update, and remove attendance records.
          </p>
        </div>
        <EntityDialog
          trigger={
          ...
          description="Log attendance for an artist session."
          submitLabel="Create record"
          pendingLabel="Creating…"
          successMessage="Attendance record created."
          action={createInstructorAttendanceAction}
        >
            ...
            accessor: (row) => (
              <div className="flex items-center gap-1">
                <EntityDialog
                  ...
                  action={updateInstructorAttendanceAction}
                ...
                <DeleteDialog
                  ...
                  action={deleteInstructorAttendanceAction}
                  trigger={
                    <Button
                      variant="destructive"
                      size="icon-sm"
